...
- **Alerting**: Adds deduping of alert notifications [#7632](https://github.com/maksimmernikov/grafana/pull/7632)
- **Alerting**: Better information about why an alert triggered [#7035](https://github.com/maksimmernikov/grafana/issues/7035)
- **Orgs**: Sharing dashboards using Grafana share feature will now redirect to correct org. [#6948](https://github.com/maksimmernikov/grafana/issues/6948)
...
Checkout the [CHANGELOG.md](https://github.com/maksimmernikov/grafana/blob/master/CHANGELOG.md) file for a complete list
